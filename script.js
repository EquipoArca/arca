...
// Función global única para traducir coordenadas en cualquier vista de ARCA
async function obtenerNombreUbicacionGlobal(textoUbicacionOriginal) {
    ...
    // Limpiamos el texto por si viene con "Ubicación GPS:" u otro prefijo
    ...
    if (textoLimpio.includes(',')) {
        ...
        if (!isNaN(lat) && !isNaN(lon)) {
            try {
                // Usamos zoom=18 para buscar calle y número exacto
