...
// Configuración de MySQL con Aiven y variables de entorno
...
app.post('/crear-reporte', (req, res) => {
    ...
    db.query("SELECT id_usuarios FROM usuarios WHERE correo_usuario = ?", [correo_usuario], (err, results) => {
        ...
        // Opcional: Evitar doble inserción por doble clic en menos de 10 segundos
...
// NUEVA RUTA AGREGADA PARA OBTENER LA FICHA DEL ADOPTANTE
...
// RUTA CAMBIADA A POST PARA EVITAR PROBLEMAS CON EL BODY EN DELETE
...
// RUTA PARA OBTENER SOLO LOS IDs DE LAS PUBLICACIONES GUARDADAS DE UN USUARIO
app.get('/api/guardados/ids/:correo', (req, res) => {
    ...
    db.query(query, [correo], (err, results) => {
        ...
        // Devuelve un arreglo plano con los IDs: [1, 5, 12]
...
// OBTENER UN REPORTE INDIVIDUAL POR ID (Para modo edición)
...
// OBTENER TODAS LAS PUBLICACIONES / NOVEDADES GLOBALES
...
db.connect(err => {
    ...
    console.log('✅ Conectado a la base de datos MySQL (basearca)');
});
